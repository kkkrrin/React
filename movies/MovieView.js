...
const MovieView = ({movieInfo,onOpen}) => {
    ...
    const {thumbUrl,movieNm,openDt,moviePrdtStat,movieType,watchGradeNm,showTs,repNationCd,director,genre,dtNm}=movieInfo



    return (
        <div className='view'>
            <img src={thumbUrl} alt={movieNm} onClick={onOpen}/>
            <div>
                <h3>{movieNm}</h3>
                <ul>
